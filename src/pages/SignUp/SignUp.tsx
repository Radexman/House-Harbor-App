          ...
          <div className="container">
            <div className="mx-auto max-w-2xl rounded-md p-4 sm:bg-primary-content sm:bg-opacity-30 ">
              <header className="space-y-3 pb-2 text-center">
                <h1 className="text-3xl font-semibold uppercase tracking-wide">Create Account</h1>
                <p className="px-4 font-semibold">
                  You can create an account at House Harbor for free. Create your profile with email or via Google
                  account.
                </p>
              </header>
